export const features = [
  {
    ...
    caption: "MAXIMIZE YOUR THROUGHPUT",
    title: "Intelligent Job Scheduling",
    text: "Our AI-powered engine analyzes your jobs, machines, and constraints to automatically generate the most profitable schedule in seconds.",
  },
  {
    id: "1",
    icon: "/images/feature-2.png",
    caption: "FROM PLAN TO REALITY",
    title: "Live Shop Floor Control",
    text: "Our simple tablet interface gives operators a clear view of their next job and lets them report progress with a single tap.",
  },
];
export const details = [
  ...
  },
  {
    id: "3",
    icon: "/images/feature-2.png",
    title: "Simple Reporting & Exports",
  },
];
